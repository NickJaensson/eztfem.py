...
addpath(append(eztfempath,"src/addons/stokes"))
...
writelines("# this test was automatically generated using create_pytfem_tests_stokes.m",fn);
mywritelines("# run with: python -m unittest test_stokes.py");
