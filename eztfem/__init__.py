"""
Top-level package API for eztfem.
"""

from .core.shapefunc import (
    basis_function,
    refcoor_nodal_points,
    isoparametric_deformation_curve,
    isoparametric_deformation,
)
from .core.system_matrix import (
    build_system,
...
from .addons.elements.poisson_elements import (
    poisson_deriv,
    poisson_elem,
    poisson_natboun_curve,
)
from .addons.elements.stokes_elements import (
    stokes_elem,
    stokes_deriv,
    stokes_flowrate_curve,
    stokes_natboun_curve,
    stokes_pressure,
)
from .addons.elements.streamfunction_elements import (
    streamfunction_elem,
...
from .addons.plotlib.plotting_functions import (
    ...
    plot_quiver,
    plot_vector,
    plot_vector_contours,
    plot_sol_contour,
    plot_vector_over_line,
    plot_basis_function,
    plot_points_curves,
    plot_gauss_legendre,
)
