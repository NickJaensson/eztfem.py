...
def gauss_legendre_triangle(p):
    ...
    match p:
        ...
        case(2):
            ...
            w = np.array([ dup21(.3333333333333333333333333333333333) ])

        case(3):
            
            x = np.reshape ( np.concatenate (
                      ( perm21(.1628828503958919109001618041849063),
                        perm21(.4779198835675637000000000000000000) ), axis=None ), [m,2] )
            
            w = np.concatenate ( (dup21(.2811498024409796482535143227020770),
                                  dup21(.0521835308923536850798190106312564)), axis=None )

        case(4):

            x = np.reshape ( np.concatenate (
                      ( perm21(.4459484909159648863183292538830519),
                        perm21(.0915762135097707434595714634022015) ), axis=None ), [m,2] )
            
            w = np.concatenate ( (dup21(.2233815896780114656950070084331228),
                                  dup21(.1099517436553218676383263249002105)), axis=None )
        ...
        case(5):
            ...
            x = np.reshape ( np.concatenate (
                       ( perm21(.1012865073234563388009873619151238),
                         ...
                         perm3(.3333333333333333333333333333333333) ), axis=None ) , [m,2] )

            w = np.concatenate ( (dup21(.1259391805448271525956839455001813),
                                  dup21(.1323941527885061807376493878331519),
                                  dup3(.2250000000000000000000000000000000)), axis=None )
        ...
        case(6):
            ...
            w = np.array([ dup21(.0508449063702068169209368091068690),
                           dup21(.1167862757263793660252896113855794),
                          dup111(.0828510756183735751935534564204425) ]).flatten()
        ...
        case(7):
            ...
            w = np.array([ dup21(.0135338625156655615668230924525939),
                        dup21(.0789512544320109813765214502977033),
                        dup21(.1286079278189060745566555330895234),
                        dup111(.0561201442833753579166666287467563) ]).flatten()
        ...
        case(9):
            ...
            w = np.array([ dup3(.0971357962827988338192419825072886),
                        ...
                        dup111(.0432835393772893772893772893772894) ]).flatten()
        ...
        case(10):
            ...
            w = np.array([ dup3(.0809374287976228802571131238165019),
                        ...
                        dup111(.0269493525918799596454494795810967) ]).flatten()
        ...
        case(11):
            ...
            w = np.array([ dup3(.0811779602968671595154759687498236),
                        ...
                        dup111(.0407279964582990396603369584816179) ]).flatten()
        ...
        case(12):
            ...
            w = np.array([ dup21(.0061662610515590172338664837852304),
                        ...
                        dup111(.0403715577663809295178286992522368) ]).flatten()
        ...
        case(13):
            ...
            w = np.array([ dup3(.0679600365868316442817744246808849),
                        ...
                        dup111(.0095906810035432627225950901661109) ]).flatten()
        ...
        case(14):
            ...
            w = np.array([ dup3(.0585962852260285941278938063477560),
                        ...
                        dup111(.0069646633735184124253997225042413) ]).flatten()
        ...
        case(15):
            ...
            w = np.array([ dup3(.0440387108784342798530173272149339),
                        ...
                        dup111(.0046143065289671031435871760918541) ]).flatten()
        ...
        case(16):
            ...
            w = np.array([ dup3(.0480221886803770905518394045805199),
                        ...
                        dup111(.0072997969394317620841125440877777) ]).flatten()
        ...
        case(17):
            ...
            w = np.array([ dup3(.0447568714443446293718364767042551),
                        ...
                        dup111(.0274443739924583277620834554147845) ]).flatten()
        ...
        case(18):
            ...
            w = np.array([ dup21(.0139778616452860209795840079905549),
                        ...
                        dup111(.0043268574608764182945223447328327) ]).flatten()
        ...
        case(19):
            ...
            w = np.array([ dup3(.0329063313889186520836143448464750),
                        ...
                        dup111(.0037999288553019139790731537136397) ]).flatten()
        ...
        case(20):
            ...
            w = np.array([ dup3(.0125376079944966565735856367723948),
                        ...
                        dup111(.0053678057381874532052474100212697) ]).flatten()
        ...
        case(21):
            ...
            w = np.array([ dup3(.0275622569528764809669070448245143),
                        ...
                        dup111(.0230767921894926813678808755218915) ]).flatten()
...
def perm111(a, b):
    c = 1 - a - b
    o = [0] * 12
    o[0:12] = [a, b, c, a, b, c, b, a, c, b, a, c]
    return np.array(o)