...
def gauss_legendre_line(n):
    ...
    match n:
        ...
        #   x(1:3) = -2 * [ .9745539561713792622630948420239256,
        #                   .8707655927996972199319323866403942,
        #                   .7029225756886985834533032060384807 ] + 1
        #   x(4) = 0
        #   x(5:7) = -x(3:-1:1)
        #   w(1:4) = [ .0647424830844348466353057163395410,
        ...
        #   x(1:5) = -2 * [ .9869532642585858600389820060422260,
        ...
        #   x(6:10) = -x(5:-1:1)
        #   w(1:5) = [ .0333356721543440687967844049466659,
        ...
        #   x(1:5) = -2 * [ .9891143290730284964019690005614287,
        ...
        #   x(6) = 0
        #   x(7:11) = -x(5:-1:1)
        #   w(1:6) = [ .0278342835580868332413768602212743,
        ...
        #   x(7:12) = [ .1252334085114689154724414,
        ...
        #   x(1:6) = -x(12:-1:7)
        #   w(7:12) = [ .2491470458134027850005624,
        ...
        #   x(7:13) = [ .0000000000000000000000000,
        ...
        #   x(1:6) = -x(13:-1:8)
        #   w(7:13) = [ .2325515532308739101945895,
        ...
        #   x(8:14) = [ .1080549487073436620662447,
        ...
        #   x(1:7) = -x(14:-1:8)
        #   w(8:14) = [ .2152638534631577901958764,
        ...
        #   x(8:15) = [ .0000000000000000000000000,
        ...
        #   x(1:7) = -x(15:-1:9)
        #   w(8:15) = [ .2025782419255612728806202,
        ...
        #   x(9:16) = [ .0950125098376374401853193,
        ...
        #   x(1:8) = -x(16:-1:9)
        #   w(9:16) = [ .1894506104550684962853967,
        ...
        #   x(9:17) = [ .0000000000000000000000000,
        ...
        #   x(1:8) = -x(17:-1:10)
        #   w(9:17) = [ .1794464703562065254582656,
        ...
        #   x(10:18) = [ .0847750130417353012422619,
        ...
        #   x(1:9) = -x(18:-1:10)
        #   w(10:18) = [ .1691423829631435918406565,
        ...
        #   x(10:19) = [ .0000000000000000000000000,
        ...
        #   x(1:9) = -x(19:-1:11)
        #   w(10:19) = [ .1610544498487836959791636,
        ...
        #   x(11:20) = [ .0765265211334973337546404,
        ...
        #   x(1:10) = -x(20:-1:11)
        #   w(11:20) = [ .1527533871307258506980843,
